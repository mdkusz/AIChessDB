...
{
    /// <summary>
    /// Form to edit matches.
    /// </summary>
    public partial class EditMatchWindow : Form, IChessDBWindow, IUIRemoteControlElement, IAIChessPlayer
    {
        ...
        public string WINDOW_ID
        {
            get
            {
                return ID_MATCHWINDOW + _match == null ? "" : _match.IdMatch.ToString();
            }
        }
        /// <summary>
        ...
        /// </summary>
        public string FriendlyName { get { return FNAME_MatchEditor; } }
        /// <summary>
        ...
        /// <summary>
        /// Current match being edited in the window.
        /// </summary>
        [Browsable(false)]
        ...
        private void EditMatchWindow_Load(object sender, EventArgs e)
        {
            Icon = Icon.Clone() as Icon;
        }

        private void EditMatchWindow_FormClosed(object sender, FormClosedEventArgs e)
        {
